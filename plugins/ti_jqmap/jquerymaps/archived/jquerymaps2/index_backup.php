...
<body>
	...
	<div id="header">
    	<div class="page">
            ...
            <div class="tools">
            	<ul id="menu">
                	<li><a href="http://www.jquerymaps.com/download/?e=html_xml_usstates_02" target="_self" class="download">DOWNLOAD</a></li>
                	<li><a href="http://www.jquerymaps.com/store/?e=html_xml_usstates_02" target="_self" class="store">STORE</a></li>
                	<li><a href="http://www.jquerymaps.com/company/contact/" target="_self"  class="email">CONTACT US</a></li>
                	<li class="last"><a href="#" target="_self" class="phone">1-866-392-0071</a></li>
                </ul>
            </div>
		</div>
    </div>
	...
	<div class="page">
        <div class="box_main">
            ...
            <div class="box span_9">
            	<div class="top"><h2 id="jqm_breadcrumbs">TRAC Interactive Maps</h2></div>
                <div class="cnt">
					...
					<div class="span_2">
                        ...
                        <div id='f_marker' class='flist hide' style="display:block;">
                            <ul class="box_tools">
                                ...
                                <li><div id="category_icon_city_4" class="marker"><img src="jquerymaps/images/icons/blue_circle.png" /></div><a id="category_marine_pool_neutral" href='Javascript:jqmShowOrHideMarkersRange("marine_pool_neutral");' class="enable" title="Hide/show this category" label="Marine Pools Facilities" >TRAC Marine Neutral Pools</a></li>
                                <li><div id="category_icon_city_2" class="marker"><img src="jquerymaps/images/icons/navy_circle.png" /></div><a id="category_marine_pool_private" href='Javascript:jqmShowOrHideMarkersRange("marine_pool_private");' class="enable" title="Hide/show this category" label="Private Pools" >TRAC Private Pool TPCP </a></li>
                                <li><div id="category_icon_city_2" class="marker"><img src="jquerymaps/images/icons/grey_circle.png" /></div><a id="category_marine_pool_coop" href='Javascript:jqmShowOrHideMarkersRange("marine_pool_coop");' class="enable" title="Hide/show this category" label="Co-op Pools" >TRAC’s contribution to Co-op Pools </a></li>
                                <li><div id="category_icon_city_3" class="marker"><img src="jquerymaps/images/icons/red_square.png" /></div><a id="category_domestic_pool" href='Javascript:jqmShowOrHideMarkersRange("domestic_pool");' class="enable" title="Hide/show this category" label="Domestic Pool Facilities" >Domestic Pool Facilities</a></li>
                                <li><div id="category_icon_city_2" class="marker"><img src="jquerymaps/images/icons/lime_triangle.png" /></div><a id="category_depots_term_lease" href='Javascript:jqmShowOrHideMarkersRange("depots_term_lease");' class="enable" title="Hide/show this category" label="Depots for Term Lease" >Depots for Term Lease</a></li>
